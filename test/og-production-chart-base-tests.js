...
function runBaseTests() {
  og_production_chart_1 = document.getElementById('og_production_chart_1');

  suite('Base Automation Tests for og-production-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-production-chart fixture is created', function() {
      assert.isTrue(document.getElementById('og_production_chart_1') !== null);
    });
